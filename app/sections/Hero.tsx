...
export default function Hero() {
    return(
        ...
        <HeroCard 
            ...
            desc="Hummingbird is an org which fosters the best research centric LLM model on this planet, built for a cause of bringing forth the AGI and the era of ultimate intelligence."
